...
QuizTranslation.create!(quiz_id: 6, translation_id: 8, correct: "yes")
QuizTranslation.create!(quiz_id: 6, translation_id: 9, correct: "yes")
QuizTranslation.create!(quiz_id: 6, translation_id: 10, correct: "yes")

QuizTranslation.create!(quiz_id: 7, translation_id: 1, correct: "yes")
QuizTranslation.create!(quiz_id: 7, translation_id: 2, correct: "no")
QuizTranslation.create!(quiz_id: 7, translation_id: 3, correct: "yes")
QuizTranslation.create!(quiz_id: 7, translation_id: 4, correct: "yes")
QuizTranslation.create!(quiz_id: 7, translation_id: 10, correct: "yes")
...
QuizTranslation.create!(quiz_id: 8, translation_id: 8, correct: "yes")
QuizTranslation.create!(quiz_id: 8, translation_id: 9, correct: "no")
QuizTranslation.create!(quiz_id: 8, translation_id: 10, correct: "no")